...
#### Map Controls ####
       div(id="MapControlPanel",class="panel panel-default controls",
            ...
            tags$div(title="Choose the type of forest data you want to work with", selectInput(inputId="MapGroup", 
              label="Type of forest data:", choices=c(Trees="trees",Saplings="saplings","Tree seedlings"="seedlings",
              Shrubs="shrubs", "Shrub seedlings"="shseedlings","Understory plants"="herbs","Vines on Trees"="vines", "Soils"="soils"))),
           ...
           conditionalPanel("input.MapGroup != 'soils'",
                  checkboxInput(inputId="mapCommon", label="Show common names?", value=TRUE )), #show commonname checkbox only when MapGroup is a plant group.
            tags$div(title="Choose a variable to map", uiOutput("MapSpeciesControl")),  
